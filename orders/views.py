...
def payments(request):
    ...
    for item in cart_items:
        ...
        # Reduse the Quantity of the sold Products
...
def place_order(request,total = 0,quantity = 0):
    ...
    #if cart item is lessthan or eqalto zero thene redirect to shop
    ...
    if request.method =='POST':
        ...
        if form.is_valid():
            #store all the databilling information  inside order table
            data = Order()
